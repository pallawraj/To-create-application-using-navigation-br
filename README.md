# To-create-application-using-navigation-br
Bubble-navigation-br
# Bubble Navigation
...
```gradle
dependencies {
    implementation 'com.pallaw8340.bubblenavigation:bubblenavigation:1.0.7'
}
```
...
<com.gauravk.bubblenavigation.BubbleNavigationConstraintView
    ...
    </com.pallaw8340.bubblenavigation.BubbleNavigationConstraintView>
```
| **attr**     | **Description**                                       |
| ------------ | ----------------------------------------------------- | 
...
```xml
<com.pallaw8340.bubblenavigation.BubbleNavigationLinearView
